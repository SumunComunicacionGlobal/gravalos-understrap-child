...
function theme_enqueue_styles() {
    ...
    // wp_enqueue_style( 'splitting', get_stylesheet_directory_uri() . '/js/splitting/splitting.css' );
    // wp_enqueue_style( 'splitting-cells', get_stylesheet_directory_uri() . '/js/splitting/splitting-cells.css' );
    ...
    // wp_enqueue_script( 'splitting', get_stylesheet_directory_uri() . '/js/splitting/splitting.min.js', null, null, true );
    wp_enqueue_script( 'slick', get_stylesheet_directory_uri() . '/js/slick/slick.min.js', null, null, true );
    // wp_enqueue_script( 'animsition', get_stylesheet_directory_uri() . '/js/animsition/animsition.min.js', null, null, true );
...
add_action( 'after_setup_theme', 'remove_align_wide_from_child_theme', 11 ); 
function remove_align_wide_from_child_theme() {
