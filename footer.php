...
<?php get_template_part( 'sidebar-templates/sidebar', 'prefooter-cta-contacto' ); ?>

<?php if ( is_front_page() ) {
	get_template_part( 'sidebar-templates/sidebar', 'prefooter-home' ); 
} elseif ( es_blog() ) {
	get_template_part( 'sidebar-templates/sidebar', 'prefooter-blog' ); 
} else {
