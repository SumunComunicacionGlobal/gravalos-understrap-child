...
function understrap_widgets_init() {
    ...
    register_sidebar(
        array(
            'name'          => __( 'Prefooter CTA Contacto', 'understrap' ),
            'id'            => 'prefooter-cta-contacto',
            'description'   => __( 'Para colocar un CTA en la parte inferior de la página', 'understrap' ),
	...
	register_sidebar(
        array(
            'name'          => __( 'Pre footer (Home)', 'understrap' ),
            'id'            => 'prefooter-home',
    ...
    register_sidebar(
        array(
            'name'          => __( 'Pre footer (excepto blog)', 'understrap' ),
            'id'            => 'prefooter',
            'description'   => __( 'Aparece antes del Pie de Página Completo', 'understrap' ),
            'before_widget' => '<div id="%1$s" class="%2$s">',
            'after_widget'  => '</div><!-- .footer-widget -->',
    ...
    register_sidebar(
        array(
            'name'          => __( 'Pre footer (blog)', 'understrap' ),
            'id'            => 'prefooter-blog',
            'description'   => __( 'Aparece antes del Pie de Página Completo (solo en el blog)', 'understrap' ),
            'before_widget' => '<div id="%1$s" class="%2$s">',
            'after_widget'  => '</div><!-- .footer-widget -->',
            'before_title'  => '<p class="widget-title">',
            'after_title'   => '</p>',
